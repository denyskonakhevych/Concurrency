...
import com.epam.sin.sum.count.SinSeriesCounterCollable;

public class SinSeriesCounterCollableTest {
	...
	public void testTimeToCountIn0Thread() {
		...
		SinSeriesCounter sum = new SinSeriesCounterCollable(LENGTH_OF_SEQUENCE, numberOfThreads);
		sum.countSeries();
	}
	...
	public void testCount1ThreadPer1ElementOk() {
		...
		SinSeriesCounter sum = new SinSeriesCounterCollable(CURRENT_LENGTH_OF_SEQUENCE, numberOfThreads);
		assertEquals(0.0, sum.countSeries(), DELTA);
	}
	...
	public void testCount1Element() {
		int numberOfThreads = 1;
		SinSeriesCounter sum = new SinSeriesCounterCollable(0, numberOfThreads);
		assertEquals(0.0, sum.countSeries(), DELTA);
	}
	...
	public void testCountSequenceStartNegativeOrPositiveSumsEquals() {
		int numberOfThreads = 2;
		SinSeriesCounter sumPlus = new SinSeriesCounterCollable(LENGTH_OF_SEQUENCE, numberOfThreads);
		SinSeriesCounter sumMinus = new SinSeriesCounterCollable(-LENGTH_OF_SEQUENCE, numberOfThreads);
